...
# secreate key for JWT
# openssl rand -hex 32 -> use this command to get secreate key in terminal
SECRET_KEY= 'bfb7c19112c3ddc6309d3a8fc5180ce1eef549b3fe7a5e1514d96bcc705a5705'
ALGORITHM = 'HS256' 
...
async def get_current_user(token:Annotated[str, Depends(oauth2_bearer)]):
    try:
        ...
        raise HTTPException (status_code=status.HTTP_401_UNAUTHORIZED,
                             detail="colud not validate user.")
